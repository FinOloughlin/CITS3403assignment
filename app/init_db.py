...
# insert Mad Libs stories and questions
stories = [
    (
    ...
    "How do you decribe the place where you are? Please enter an adjective.|Please enter an animal you like.|If there were a dangerous monster, what would it be?|What do you fear the most? Please enter a plural noun.|Who is your favorite family member? Please enter a relative."
    )
